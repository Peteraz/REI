...
<html>
  ...
  <body>
      <div  class="container">
             ...
             <div id="tb" >
                  <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="Edit()">审核</a>
              </div>
      </div>
      ...
      <div id="dlg-buttons">
            ...
            <div id="dlg" class="easyui-dialog" style="width:400px" closed="true" buttons="#dlg-buttons">
                <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px">
                     <div style="margin-bottom:20px;font-size:14px;border-bottom:1px solid #ccc">审核</div>
                     <div style="margin-bottom:10px">
                           <label>财务签名:</label>
                           <input type="text" name="financial_sign" id="financial_sign" required="true"  style="width:100%">
                     </div>
                     <div style="margin-bottom:10px">
                           <label>财务操作:</label>
                           <input type="text" name="financial_op" id="financial_op" required="true" style="width:100%">
                     </div> 
                      <div style="margin-bottom:10px">
                           <label>报销金额:</label>
                           <input type="text" name="remoney" id="remoney" required="true" style="width:100%">
                     </div> 
                     <div style="margin-bottom:10px">
                           <label>结果:</label><br/>
                           <textarea name="result" id="result" rows="3" cols="20" required="true" style="height:50px;width:300px"></textarea>
                     </div>    
      ...
      <script type="text/javascript">
        $('#dg').datagrid({
                     url:"reimbursement!pends.action",        //从远程站点请求数据的 URL。
                     title:'待审核',                               //数据表名
                     toolbar: '#tb',
                     method: 'post',
                     width: 'auto',
                     ...
                     columns:[[                                //Column是一个数组对象，它的每个元素也是一个数组。
		                 ...
		                 {field:'financial_sign',title:'财务签名',width:100},
		                 {field:'financial_op',title:'财务审批',width:100},
		                 ...
		                 {field:'remoney',title:'报销金额',width:50},
		                 {field:'hospital_level',title:'医院级别',width:100},
                     ...
                     onSelectPage:function(pageNumber, pageSize){
		                   $.ajax({
                                       ...
                                       type:'POST',
                                       //提交的地址
                                       url:'reimbursement!reloadpends.action',
                                       //提交的数据
                                       data:{
                                           pnumber:pageNumber,
                                           psize:pageSize,
	                  ...
	                  onChangePageSize:function(pageSize){
	                       ...
	                       $.ajax({
                                       ...
                                       type:'POST',
                                       //提交的地址
                                       url:'reimbursement!reloadpendsp.action',
                                       //提交的数据
                                       data:{
                                           psize:pageSize,
                                       },
                ...
                function Submit(){
                 ...
                 function  EditUser(uid){
                     ...
                     $.ajax({
                        ...
                        type:'POST',
                        //提交的地址
                        url:'reimbursement!reloadpend.action',
                        //提交的数据
                        data:{
                             id:uid,
                             financial_sign:$("#financial_sign").val(),
                             financial_op:$("#financial_op").val(),
                             remoney:$("#remoney").val(),
                             result:$("#result").val(),
                             pnumber:pnumber,
                             psize:psize
