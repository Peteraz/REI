...
<html>
  <head>
    ...
    <link rel="stylesheet" href="./css/ipicture.css" >
    <link href="./custom/uimaker/easyui.css" rel="stylesheet" >
  </head>
  
  <body>
       <form action="upload!uploadpicture.action?type=ip" method="post" enctype="multipart/form-data" >   
           <div class="upload">  
               <center><h1 style="font-size: x-large!important;">上传身份证照片</h1></center>                                 
       ...
       <script type="text/javascript">
            ...
            function checkImg(){    
                  ...
                  var maxsize = 2*1024*1024;    //不能超过3M
