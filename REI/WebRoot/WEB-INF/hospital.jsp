...
<html>
  ...
  <body>
      <form action="reimbursement!applyho.action" method="post" enctype="multipart/form-data">
              <center>
              <table cellspacing="50">
                    ...
                    <tr>
                         <td colspan="2"><center>药费单    请选择上传的文件：<input type="file" id="file1" name="file" onchange="checkImg1()"/></center></td>
                    </tr>
                    <tr>
                         <td colspan="2"><center>病      历    请选择上传的文件：<input type="file" id="file1" name="file" onchange="checkImg2()"/></center></td>
                    </tr>
                    <tr>
                         <td colspan="2"><center>补       充     请选择上传的文件：<input type="file" id="file1" name="file" onchange="checkImg3()"/></center></td>
                    </tr>
                    <tr>
                        <td colspan="2"><center><input type="submit" class="submit" value="提交" onclick="return check()"/></center></td>
                    </tr>
                   <%--  <tr>
                        <td colspan="2"><center><b style="color: rgba(0, 0, 255, 0.94);">${uploadpstatus}</b></center></td>         
                    </tr>
                    <tr>
                        <td colspan="2"><center><b style="color: rgba(0, 0, 255, 0.94);">${applyhostatus}</b></center></td>
                    </tr> --%>
              </table>
              </center>
        </form>
